...
#define P_LVL_UP_LEARNSETS          GEN_9  // Choose which set of Level Up Learnsets to use.
                                                ...
                                                // (GEN_9: SV For species present in those games. Otherwise use GEN_8.) Legacy comment that explains how it used to work.
                                                // GEN_9 NOW defaults to Heart and Soul movesets. Which prioritizes Heart and Soul movesets, then normal Gen 9 behavior.
