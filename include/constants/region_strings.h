//
// DO NOT MODIFY THIS FILE! It is auto-generated from src/data/region_map/regions.json and Inja template src/data/region_map/regions.strings.header.json.txt
//

#ifndef GUARD_REGION_STRINGS_TEST_H
#define GUARD_REGION_STRINGS_TEST_H
