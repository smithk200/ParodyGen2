...
enum
{
    ...
    OBJ_EVENT_GFX_LEGENDARY_SHADOW,
    OBJ_EVENT_GFX_TOWER_BEAM,
    OBJ_EVENT_GFX_LEADER_DAMIAN,
    OBJ_EVENT_GFX_MACHINE,
    OBJ_EVENT_GFX_LEADER_RICK,
    OBJ_EVENT_GFX_LEADER_MORTY,
    OBJ_EVENT_GFX_LEADER_BEA,
    OBJ_EVENT_GFX_LEADER_MATT,
    OBJ_EVENT_GFX_LEADER_BRIE,
    OBJ_EVENT_GFX_LEADER_CLAY,
    OBJ_EVENT_GFX_JOY,
    OBJ_EVENT_GFX_ELITE_FOUR_MACY,
    OBJ_EVENT_GFX_ELITE_FOUR_NED,
    OBJ_EVENT_GFX_ELITE_FOUR_SANS,
    OBJ_EVENT_GFX_MOLLY,
    ...
    OBJ_EVENT_GFX_SLOWPOKE_CORRUPT,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_JANINE                  0x1140
#define OBJ_EVENT_PAL_TAG_WILL                    0x1141
#define OBJ_EVENT_PAL_TAG_KAREN                   0x1142
#define OBJ_EVENT_PAL_TAG_LANCE                   0x1143
#define OBJ_EVENT_PAL_TAG_TOWER_BEAM              0x1144

#define OBJ_EVENT_PAL_TAG_ROCKET_1                0x1145
#define OBJ_EVENT_PAL_TAG_ROCKET_2                0x1146
#define OBJ_EVENT_PAL_TAG_ROCKET_3                0x1147
#define OBJ_EVENT_PAL_TAG_ROCKET_4                0x1148
#define OBJ_EVENT_PAL_TAG_FALKNER                 0x1149
#define OBJ_EVENT_PAL_TAG_BUGSY                   0x114A
#define OBJ_EVENT_PAL_TAG_WHITNEY                 0x114B
#define OBJ_EVENT_PAL_TAG_MORTY                   0x114C
#define OBJ_EVENT_PAL_TAG_JASMINE                 0x114D
#define OBJ_EVENT_PAL_TAG_CHUCK                   0x114E
#define OBJ_EVENT_PAL_TAG_PRYCE                   0x114F
