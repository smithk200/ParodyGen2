...
extern const u8 BattleScript_FaintBattlerNuzlocke[];
...
extern const u8 BattleScript_MultiHitPrintStrings_Singular[];
extern const u8 BattleScript_BattlerAvoidedMultiHit[];
extern const u8 BattleScript_BattlerAvoidedMultiHit_Singular[];
