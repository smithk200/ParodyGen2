...
/*
static const u32 sSlidingPuzzle_Gfx[]     = INCGFX_U32("graphics/sliding_puzzle/bg.png", ".4bpp");
...
//static const u32 sCursor_Gfx[]      = INCGFX_U32("graphics/sliding_puzzle/cursor.png", ".4bpp");
