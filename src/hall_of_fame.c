...
static void HallOfFame_PrintPlayerInfo(u8 unused1, u8 unused2)
{
    ...
    if (FlagGet(FLAG_NUZLOCKE) && (!(FlagGet(FLAG_USED_ITEM_NUZLOCKE))))
    {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 12, 1, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_HnSHardcore);
    }
    else if (FlagGet(FLAG_NUZLOCKE) && (FlagGet(FLAG_USED_ITEM_NUZLOCKE)))
    {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 26, 1, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_HnSNuzlocke);
    }
    else
    {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 23, 1, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_HnS);
    }
