...
{
    if (IS_FRLG)
        return gMapHeader.mapLayout->secondaryTileset == &gTileset_GenericBuilding
...
bool8 HasLearnedAllMovesFromCapeBrinkTutor(void)
{
    ...
    return (FlagGet(FLAG_GARBAGEFLAG) == TRUE)
        && (FlagGet(FLAG_GARBAGEFLAG) == TRUE)
        && (FlagGet(FLAG_GARBAGEFLAG) == TRUE);
}
...
void SetHpStat(void)
{
    ...
    SetMonData(gParties[B_TRAINER_OPPONENT_A], MON_DATA_HP, &HpStat);
    SetMonData(gParties[B_TRAINER_OPPONENT_A], MON_DATA_MAX_HP, &HpStat);
}
...
void SetAtkStat(void)
{
    ...
    SetMonData(gParties[B_TRAINER_OPPONENT_A], MON_DATA_ATK, &AtkStat);
}
...
void SetDefStat(void)
{
    ...
    SetMonData(gParties[B_TRAINER_OPPONENT_A], MON_DATA_DEF, &DefStat);
}
...
void SetSpdStat(void)
{
    ...
    SetMonData(gParties[B_TRAINER_OPPONENT_A], MON_DATA_SPEED, &SpdStat);
}
...
void SetSpAtkStat(void)
{
    ...
    SetMonData(gParties[B_TRAINER_OPPONENT_A], MON_DATA_SPATK, &SpAtkStat);
}
...
void SetSpDefStat(void)
{
    ...
    SetMonData(gParties[B_TRAINER_OPPONENT_A], MON_DATA_SPDEF, &SpDefStat);
}
...
void SwitchMonAbility(void)
{
    ...
    u8 currentAbilityNum = GetMonData(&gParties[B_TRAINER_PLAYER][gSpecialVar_0x8004], MON_DATA_ABILITY_NUM, NULL);
    ...
    if (gSpeciesInfo[species].abilities[1] != 0 && gSpeciesInfo[species].abilities[0] != gSpeciesInfo[species].abilities[1])
    {
        ...
        SetMonData(&gParties[B_TRAINER_PLAYER][gSpecialVar_0x8004], MON_DATA_ABILITY_NUM, &newAbilityNum);
        gSpecialVar_Result = TRUE;
    }
    else
    {
