...
static void DrawChoices_AutoHMs(int selection, int y);
...
} static const sItemFunctionsMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_AUTO_HMS]                = {DrawChoices_AutoHMs,          ProcessInput_Options_Two},
...
struct // MENU_CUSTOM
{
    ...
    {
    [MENUITEM_BATTLE_EXP_SHARE]       = {DrawChoices_EXPShare,          ProcessInput_Options_Two},
...
static const u8 gText_TerrainModern[] = _("Modern");
static const u8 gText_TerrainGeneric[] = _("Default");
static const u8 gText_RunOptionDisabled[] = _("Default");
static const u8 gText_RunOptionEnabled1[] = _("L+A");
static const u8 gText_RunOptionEnabled2[] = _("(B)");
static const u8 gText_OptionFont[] = _("Font");
static const u8 gText_OptionFontEmerald[] = _("Emerald");
static const u8 gText_OptionFontFireRed[] = _("Fire Red");
static const u8 gText_Font[] = _("Font");
static const u8 gText_EXPShare[] = _("Exp. Share");
static const u8 gText_AutoHMs[] = _("Auto-HMs");
static const u8 gText_Followers[] = _("Followers");
static const u8 gText_OptionStyle[] = _("Move Split");
static const u8 gText_Terrain[] = _("Terrain");
static const u8 gText_RunType[] = _("Run Type");
static const u8 gText_OptionDifficulty[] = _("Difficulty");
static const u8 gText_AutorunEnable[] = _("Autorun");  //tx_optionsPlus
static const u8 gText_OptionMatchCalls[] = _("Match Calls");  //tx_optionsPlus

static const u8 gText_Easy[] = _("Easy");
static const u8 gText_Hard[] = _("Hard");
...
static const u8 *const sOptionMenuItemsNamesMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_AUTO_HMS]            = gText_AutoHMs,
    [MENUITEM_MAIN_FONT]                = gText_OptionFont,
    [MENUITEM_MAIN_BATTLESTYLE]         = gText_BattleStyle,
    [MENUITEM_MAIN_BUTTONMODE]          = gText_ButtonMode,
    [MENUITEM_MAIN_FOLLOWER]            = gText_Followers,
...
{
    [MENUITEM_BATTLE_EXP_SHARE]       = gText_EXPShare,
    ...
    [MENUITEM_BATTLE_CANCEL] = COMPOUND_STRING("Save"),
};
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_MAIN:
        ...
        case MENUITEM_MAIN_AUTO_HMS:          return TRUE;
    ...
    case MENU_CUSTOM:
        switch(selection)
        {
        case MENUITEM_BATTLE_EXP_SHARE:       return TRUE;
        ...
        case MENUITEM_BATTLE_LR_RUN:          return sOptions->sel_custom[MENUITEM_BATTLE_RUN_TYPE] == 1 || sOptions->sel_custom[MENUITEM_BATTLE_RUN_TYPE] == 3;
...
static const u8 sText_Desc_AutoHMsOn[]             = _("Skips the prompt to use\nan HM move.");
static const u8 sText_Desc_AutoHMsOff[]             = _("Shows the prompt to use\nHM moves.");
static const u8 sText_Desc_Font_Emerald[]             = _("Uses the font from\nPokémon Emerald.");
static const u8 sText_Desc_Font_FR[]             = _("Uses the font from\nPokémon Fire Red.");
...
static const u8 *const sOptionMenuItemDescriptionsMain[MENUITEM_MAIN_COUNT][3] =
{
    ...
    [MENUITEM_MAIN_AUTO_HMS]  = {sText_Desc_AutoHMsOn,      sText_Desc_AutoHMsOff, sText_Empty},
    [MENUITEM_MAIN_FONT] = {sText_Desc_Font_Emerald, sText_Desc_Font_FR, sText_Empty},
...
static const u8 sText_Desc_EXPShareOn[]            = _("EXP is applied to all members in\nthe party, similar to Gen VI.");
static const u8 sText_Desc_EXPShareOff[]           = _("EXP is only applied to the\nparticipating members of battle.");

static const u8 *const sOptionMenuItemDescriptionsCustom[MENUITEM_BATTLE_COUNT][4] =
{
    [MENUITEM_BATTLE_EXP_SHARE]          = {sText_Desc_EXPShareOn,                  sText_Desc_EXPShareOff},
...
static const u8 *const sOptionMenuItemDescriptionsSound[MENUITEM_SOUND_COUNT][6] =
{
    ...
    [MENUITEM_SOUND_WILD_MON_MUSIC] = {sText_Desc_WildMonMusic_Custom,     sText_Desc_WildMonMusic_Kanto_Old,      sText_Desc_WildMonMusic_Sinnoh,      sText_Desc_WildMonMusic_Johto,     sText_Desc_WildMonMusic_Hoenn,     sText_Desc_WildMonMusic_Random},
    [MENUITEM_SOUND_BATTLE_TRAINER_MUSIC] = {sText_Desc_WildMonMusic_Custom,     sText_Desc_WildMonMusic_Kanto_Old,      sText_Desc_WildMonMusic_Sinnoh,      sText_Desc_WildMonMusic_Johto,     sText_Desc_WildMonMusic_Hoenn,     sText_Desc_WildMonMusic_Random},
    [MENUITEM_SOUND_BATTLE_FRONTIER_TRAINER_MUSIC] = {sText_Desc_WildMonMusic_Custom,     sText_Desc_WildMonMusic_Kanto_Old,      sText_Desc_WildMonMusic_Sinnoh,      sText_Desc_WildMonMusic_Johto,     sText_Desc_WildMonMusic_Hoenn,     sText_Desc_WildMonMusic_Random},
...
static const u8 *const sOptionMenuItemDescriptionsDisabledMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_AUTO_HMS]   = sText_Empty,
...
{
    [MENUITEM_BATTLE_EXP_SHARE]          = sText_Empty,
...
static const u8 *const OptionTextDescription(void)
{
    ...
    default:
        ...
        if (
            ...
            || menuItem == MENUITEM_BATTLE_FAST_BATTLES
...
static const u8 sText_TopBar_Custom_Right[] = _("{R_BUTTON}Sound");
...
static void DrawTopBarText(void)
{
    ...
    {
    case MENU_MAIN:
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 106, 1, color, 0, sText_TopBar_Main);
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 185, 1, color, 0, sText_TopBar_Main_Right);
            break;
        case MENU_CUSTOM:
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 106, 1, color, 0, sText_TopBar_Custom);
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 2, 1, color, 0, sText_TopBar_Custom_Left);
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 185, 1, color, 0, sText_TopBar_Custom_Right);
            break;
        case MENU_SOUND:
...
void CB2_InitOptionPlusMenu(void)
{
    ...
    case 6:
        ...
        sOptions->sel[MENUITEM_MAIN_AUTO_HMS] = gSaveBlock2Ptr->optionsAutoHMs;
        sOptions->sel[MENUITEM_MAIN_FONT] = gSaveBlock2Ptr->optionsFont;
        ...
        sOptions->sel_custom[MENUITEM_BATTLE_EXP_SHARE]        = gSaveBlock2Ptr->optionsEXPShare;
        ...
        sOptions->sel_custom[MENUITEM_BATTLE_BALL_PROMPT]       = gSaveBlock2Ptr->optionsBallPrompt;
        sOptions->sel_custom[MENUITEM_BATTLE_NEW_BACKGROUNDS]   = gSaveBlock2Ptr->optionsNewBackgrounds;
        sOptions->sel_custom[MENUITEM_BATTLE_RUN_TYPE]          = gSaveBlock2Ptr->optionsRunType;
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsAutoHMs              = sOptions->sel[MENUITEM_MAIN_AUTO_HMS];
    gSaveBlock2Ptr->optionsFont              = sOptions->sel[MENUITEM_MAIN_FONT];
    ...
    gSaveBlock2Ptr->optionsEXPShare        = sOptions->sel_custom[MENUITEM_BATTLE_EXP_SHARE];
    ...
    gSaveBlock2Ptr->optionsBallPrompt       = sOptions->sel_custom[MENUITEM_BATTLE_BALL_PROMPT];
    gSaveBlock2Ptr->optionsNewBackgrounds   = sOptions->sel_custom[MENUITEM_BATTLE_NEW_BACKGROUNDS];
    gSaveBlock2Ptr->optionsRunType          = sOptions->sel_custom[MENUITEM_BATTLE_RUN_TYPE];
...
static void DrawChoices_EXPShare(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_BATTLE_EXP_SHARE);
    u8 styles[2];
...
static void DrawChoices_AutoHMs(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_AUTO_HMS);
    u8 styles[2];
...
static void DrawChoices_Wild_Battle_Music(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gSaveBlock2Ptr->optionsWildBattleMusic = 0; // Dark Gold
    }
    else if (selection == 1)
    {
    ...
    {
        gSaveBlock2Ptr->optionsWildBattleMusic = 4; // Hoenn
    }
    else //(selection == 5)
    {
...
static void DrawChoices_Trainer_Battle_Music(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gSaveBlock2Ptr->optionsTrainerBattleMusic = 0; // Dark Gold
    }
    else if (selection == 1)
    {
    ...
    {
        gSaveBlock2Ptr->optionsTrainerBattleMusic = 4; // Hoenn
    }
    else //(selection == 5)
    {
...
static void DrawChoices_Frontier_Trainer_Battle_Music(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gSaveBlock2Ptr->optionsFrontierTrainerBattleMusic = 0; // Dark Gold
    }
    else if (selection == 1)
    {
    ...
    {
        gSaveBlock2Ptr->optionsFrontierTrainerBattleMusic = 4; // Hoenn
    }
    else //(selection == 5)
    {
...
static void DrawChoices_LargeFollower(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_COUNT);
    u8 styles[2] = {0};
    styles[selection] = 1;
...
static void DrawChoices_Run_Type(int selection, int y)
{
    ...
    if (selection == 0)
    {
        ...
        sOptions->sel_custom[MENUITEM_BATTLE_LR_RUN]          = gSaveBlock2Ptr->optionsLRtoRun = 1;
    }
    else if (selection == 1)
    {
