...
void UpdateHpTextInHealthbox(u32 healthboxSpriteId, u32 maxOrCurrent, s16 currHp, s16 maxHp)
{
    ...
    case BATTLE_COORDS_SINGLES:
    {
        ...
        {
            PrintHpOnHealthbox(healthboxSpriteId, currHp, maxHp, 3, 16); // See the number 3? That's palette indice 3, jsyk. It looks more natural.
        }
        else // Opponent
        {
...
static void UpdateStatusIconInHealthbox(u8 healthboxSpriteId)
{
    ...
    else
    {
        ...
        //For some reason, the HnS battle interface healthboxes have to do this tile swap in order to look good.
