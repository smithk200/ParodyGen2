...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_PHOEBE] = REMATCH(TRAINER_CHASE_E4_1, TRAINER_CHASE_E4_1, TRAINER_CHASE_E4_1, TRAINER_CHASE_E4_1, TRAINER_CHASE_E4_1, MAP_EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_SHREK, TRAINER_SHREK, TRAINER_SHREK, TRAINER_SHREK, TRAINER_SHREK, MAP_EVER_GRANDE_CITY),
...
u8 GetScaledLevel(u8 lvl)
{
    ...
    if (!FlagGet(FLAG_IS_CHAMPION))
    {
        if ((IsTrainerReadyForRematch() == TRUE)  && (gSaveBlock2Ptr->optionsDifficulty == 2)) 
        ...
        else if ((IsTrainerReadyForRematch() == TRUE)  && (gSaveBlock2Ptr->optionsDifficulty == 1)) 
        ...
        else if ((IsTrainerReadyForRematch() == TRUE)  && (gSaveBlock2Ptr->optionsDifficulty == 0)) 
