...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM51] =
    {
        .name = ITEM_NAME("TM51"), //Trailblaze
        .price = 3000,
        .description = COMPOUND_STRING(
            "The user attacks\n"
            "from tall grass,\n"
    ...
    [ITEM_TM52] =
    {
        .name = ITEM_NAME("TM52"), //Stomping Tantrum
        .price = 3000,
        .description = COMPOUND_STRING(
            "Stomps around\n"
            "angrily. Stronger\n"
    ...
    [ITEM_TM54] =
    {
        .name = ITEM_NAME("TM54"), //Dazzling Gleam
        .price = 3000,
        .description = COMPOUND_STRING(
            "Damages foes by\n"
            "emitting a\n"
    ...
    [ITEM_TM57] =
    {
        .name = ITEM_NAME("TM57"), //Grass Knot
        .price = 3000,
        .description = COMPOUND_STRING(
            "Uses grass to trip\n"
            "foe. Does more damage\n"
            "depending on weight."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
...
// GEN 9 ITEMS
    ...
    [ITEM_SITRUS_BERRY_OLD] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_Medicine,
        .battleUsage = EFFECT_ITEM_RESTORE_HP,
        .effect = gItemEffect_SitrusBerryOld,
        .flingPower = 10,
        .iconPic = gItemIcon_SitrusBerry,
        .iconPalette = gItemIconPalette_SitrusBerry,
    },
